...
var ReservationController = function () {
    ...
    var ReservationController = _classThis = /** @class */ (function () {
        function ReservationController_1() {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            reservation = new reservation_model_1.default(reservationData);
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, "Reservation on nane ".concat(reservationData.name, " in hotel ").concat(reservationData.hotelChoice, " ").concat(reservationData.rooms, " was completed")];
                        case 2:
                            error_1 = _a.sent();
